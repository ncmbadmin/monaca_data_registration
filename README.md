# 【Monaca】ニフティクラウドmobile backend を体験しよう！
![画像1](/readme-img/001.png)

## 概要
* Monacaを利用して、[ニフティクラウドmobile backend](http://mb.cloud.nifty.com/)へデータ登録を行うサンプルアプリです
...
```
#### SDKインストール方法
SDKが最新になっていない場合は、以下画像を参考いただき、ご自身でSDKを更新してください
